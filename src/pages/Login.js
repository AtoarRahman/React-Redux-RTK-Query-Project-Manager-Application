...
export default function Login() {
    ...
    return (
        <div className="grid place-items-center h-screen bg-slate-600">
            <div className="flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-gray-800">
                        ...
                        <div className="rounded-md shadow-sm -space-y-px">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    required
                                    className="appearance-none rounded-none relative block w-full px-3 py-2 border border border-slate-700 bg-slate-800 placeholder-gray-500 text-white rounded-b-md focus:outline-none focus:ring-violet-500 focus:border-violet-500 focus:z-10 sm:text-sm focus:bg-slate-600 focus:text-white"
